...
public class ItemSpawner : MonoBehaviour
{
    ...
    //When the items are spawning they use weight to determine which is spawned more frequently.
    //These are picked at random.
    //Whatever is picked is then Instantiated into the GameObject.
