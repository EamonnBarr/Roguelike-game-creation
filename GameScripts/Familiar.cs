...
//Similar to movement functions in player controller, this is for the Familiar of the player. They will shoot in the same directions and move in the same directions however the offset stops them from being ontop of the player.
