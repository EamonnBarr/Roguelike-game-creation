...
public class GridController : MonoBehaviour
{
    ...
    //Makes grid two tiles smaller than the actual room.
    void Awake()
    {
    ...
    //Grid generation according to the values that are set, columns, offset and rows etc. Which can be changed in unity.
    //Grid object then spawned.
